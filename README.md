...
For the model, the current deepseek-coder-1.3b-instruct.Q4_K_M.gguf [link here](https://huggingface.co/TheBloke/deepseek-coder-1.3b-instruct-GGUF/blob/main/deepseek-coder-1.3b-instruct.Q4_K_M.gguf), works like a charm.
